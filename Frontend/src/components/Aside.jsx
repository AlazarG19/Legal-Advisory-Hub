                  ...
                  <div className="menu-sub menu-sub-accordion">
                    ...
                    <div className="menu-item">
                      <div className="menu-content">
                        <a
                          className="btn btn-flex btn-color-gray-500 btn-icon-gray-400 d-flex flex-stack fs-base p-0 ms-2 mb-2 toggle collapsible collapsed"
                          data-bs-toggle="collapse"
                          href="file:///C:/Users/zoro/Music/Keen%20v3.0.3/Keen%20v3.0.3/demo1/dist/index.html#kt_app_sidebar_menu_dashboards_collapse"
                    ...
                    >
                      ...
                      <div className="menu-sub menu-sub-accordion">
                        ...
                        <div className="menu-item">
                          <a
                            className="menu-link"
                            href="file:///C:/Users/zoro/Music/Keen%20v3.0.3/Keen%20v3.0.3/demo1/dist/utilities/search/users.html"
                          >
                            <span className="menu-bullet">
                              <span className="bullet bullet-dot" />
                            </span>
                        ...
                        <div className="menu-item">
                          <a
                            className="menu-link"
                            href="file:///C:/Users/zoro/Music/Keen%20v3.0.3/Keen%20v3.0.3/demo1/dist/utilities/search/select-location.html"
                          >
                            <span className="menu-bullet">
                              <span className="bullet bullet-dot" />
                            </span>
