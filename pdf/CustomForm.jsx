        ...
        <div className="d-flex flex-column flex-root app-root" id="kt_app_root">
            ...
            <div className="stepper stepper-links d-flex flex-column" id="kt_modal_create_project_stepper">
                ...
                <div className="container">
                            ...
                            <div className="w-100">
                                ...
                                <div className="fv-row mb-15" data-kt-buttons="true">
                                    ...
                                    <label className="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 mb-6 active">
                                        {/* <!--begin::Input--> */}
                                        <input className="btn-check" type="radio" defaultChecked="checked" name="project_type" value="1" />
                                        {/* <!--end::Input--> */}
                                        {/* <!--begin::Label--> */}
                        ...
                        <div className="current" data-kt-stepper-element="content">
                            ...
                            <div className="w-100">
                                ...
                                <div className="fv-row mb-8">
                                    ...
                                    {/* <!--end::Label--> */}
                                    {/* <!--begin::Input--> */}
                                    <input type="text" className="form-control form-control-solid" placeholder="Enter Project Name" value={input1} onChange={(e) => { setInput1(e.target.value) }} name="settings_name" />
                                    {/* <!--end::Input--> */}
                                </div>
                                {/* <!--end::Input group--> */}
                                {/* <!--begin::Input group--> */}
                    ...
                    {/* <!--end::Form--> */}
                    {/* <!--end::Form--> */}
                    <PDFDownloadLink document={<MyDocument input={finalinput} />} fileName="somename.pdf">
