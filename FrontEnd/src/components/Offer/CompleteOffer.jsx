                  ...
                  >
                    ...
                    <div className="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                      ...
                      <select
                        ...
                        data-select2-id="select2-data-10-31lq"
                        tabIndex={-1}
                        aria-hidden="true"
                        data-kt-initialized={1}
                      >
                        ...
                        <option
                          value="US"
                          selected="selected"
                          data-select2-id="select2-data-12-ar5j"
                        >
                          United States
                        </option>
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-11-9dm8"
                        style={{ width: "100%" }}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabIndex={0}
                            aria-disabled="false"
                            aria-labelledby="select2-country-j6-container"
                            aria-controls="select2-country-j6-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-country-j6-container"
                              role="textbox"
                              aria-readonly="true"
                              title="United States"
                            >
