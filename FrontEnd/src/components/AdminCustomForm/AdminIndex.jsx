...
const AdminIndex = () => {
    ...
    const onRowClick = (e) => {
        console.log(e[0])
        let link = "http://localhost:5173/customforms/" + e[0]
        window.location.href = link
    }
    const onAdd = () => {
        let link = "http://localhost:5173/customforms/add"
        window.location.href = link
    }
                                ...
                                <div id="kt_app_content" className="app-content flex-column-fluid">
                                    ...
                                    <div id="kt_app_content_container" className="app-container container-xxl">
                                        ...
                                        <div className="card card-flush mb-9" id="kt_user_profile_panel">
                                            <button type="button" className="btn btn-lg btn-primary mx-10" onClick={onAdd} data-kt-element="settings-next">
                                            ...
                                            <div className="col-xl-8">
                                                ...
                                                <div className="card card-flush h-xl-100">
                                                    ...
                                                    <div className="card-header pt-7">
                                                        {/* <!--begin::Title--> */}
                                                        <h3 className="card-title align-items-start flex-column">
                                                            <span className="card-label fw-bold text-dark">List of Custom Forms</span>
                                                            <span className="text-gray-400 mt-1 fw-semibold fs-6">Total 2,356 Custom Forms Available</span>
                                                        </h3>
                                                        {/* <!--end::Title--> */}
                                                    </div>
                                                    {/* <!--end::Card header--> */}
