  ...
  return (
    <div>
      <>
        ...
        />
        <div className="d-flex flex-column flex-root app-root" id="kt_app_root" style={{ display: 'flex' }}>
          <div className="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            >
              ...
              <div className="app-main flex-column flex-row-fluid" id="kt_app_main">
                <div className="d-flex flex-column flex-column-fluid" style={{ width: '84%', position: 'absolute', left: '259px', top: '104px' }}>
                  <Content />
                </div>
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="d-flex align-items-center">
                                ...
                                />
                                <span className="tagify__tag-text">Argentina</span>
                              </div>
                            </tag>
                            <tag
                              title="Australia"
                            ...
                            >
                              ...
                              <div className="d-flex align-items-center">
                                ...
                                />
                                <span className="tagify__tag-text">Australia</span>
                              </div>
                            </tag>
                            <span
                              contentEditable=""
        ...
        <div className="flatpickr-calendar hasTime rangeMode animate" tabIndex={-1}>
