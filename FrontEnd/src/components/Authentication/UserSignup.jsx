...
const UserSignup = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                await axios.post("http://localhost:3000/createUserProfile", formData, {
                    headers: {
                                ...
                                <div class="d-flex flex-stack flex-wrap align-items-end">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1">Setup Your User Profile</a>
