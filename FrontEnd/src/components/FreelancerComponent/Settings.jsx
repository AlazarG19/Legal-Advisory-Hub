              ...
              <div className="row mb-6">
                ...
                <div className="col-lg-8 fv-row fv-plugins-icon-container">
                  <select
                    ...
                    className="form-select form-select-solid form-select-lg fw-semibold select2-hidden-accessible"
                    data-select2-id="select2-data-10-5f64"
                    tabIndex={-1}
                    aria-hidden="true"
                    data-kt-initialized={1}
                  >
                    <option value="" data-select2-id="select2-data-12-jvrw">
                      Select a Country...
                    </option>
                  ...
                  <span
                    ...
                    dir="ltr"
                    data-select2-id="select2-data-11-zymz"
                    style={{ width: "100%" }}
                  >
                    <span className="selection">
                      <span
                        className="select2-selection select2-selection--single form-select form-select-solid form-select-lg fw-semibold"
                        role="combobox"
                        aria-haspopup="true"
                        aria-expanded="false"
                        tabIndex={0}
                        aria-disabled="false"
                        aria-labelledby="select2-country-lz-container"
                        aria-controls="select2-country-lz-container"
                      >
                        <span
                          className="select2-selection__rendered"
                          id="select2-country-lz-container"
                          role="textbox"
                          aria-readonly="true"
              ...
              <div className="row mb-6">
                ...
                <div className="col-lg-8 fv-row fv-plugins-icon-container">
                  ...
                  <select
                    ...
                    data-select2-id="select2-data-13-rzah"
                    tabIndex={-1}
                    aria-hidden="true"
                    data-kt-initialized={1}
                  >
                    <option value="" data-select2-id="select2-data-15-sh9j">
                      Select a Language...
                    </option>
                    <option data-kt-flag="flags/indonesia.svg" value="id">
                  ...
                  <span
                    className="select2 select2-container select2-container--bootstrap5"
                    dir="ltr"
                    data-select2-id="select2-data-14-2s1x"
                    style={{ width: "100%" }}
                  >
                    <span className="selection">
                      <span
                        className="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
                        role="combobox"
                        aria-haspopup="true"
                        aria-expanded="false"
                        tabIndex={0}
                        aria-disabled="false"
                        aria-labelledby="select2-language-41-container"
                        aria-controls="select2-language-41-container"
                      >
                        <span
                          className="select2-selection__rendered"
                          id="select2-language-41-container"
                          role="textbox"
                          aria-readonly="true"
                  ...
                  {/*begin::Hint*/}
                  <div className="form-text">
                    Please select a preferred language, including date, time,
              ...
              <div className="row mb-6">
                ...
                <div className="col-lg-8 fv-row fv-plugins-icon-container">
                  <select
                    ...
                    className="form-select form-select-solid form-select-lg select2-hidden-accessible"
                    data-select2-id="select2-data-16-hs2s"
                    tabIndex={-1}
                    aria-hidden="true"
                    data-kt-initialized={1}
                  >
                    <option value="" data-select2-id="select2-data-18-4r4u">
                      Select a Timezone..
                    </option>
                    <option
                  ...
                  <span
                    className="select2 select2-container select2-container--bootstrap5"
                    dir="ltr"
                    data-select2-id="select2-data-17-8ng8"
                    style={{ width: "100%" }}
                  >
                    <span className="selection">
                      <span
                        ...
                        tabIndex={0}
                        aria-disabled="false"
                        aria-labelledby="select2-timezone-hw-container"
                        aria-controls="select2-timezone-hw-container"
                      >
                        <span
                          className="select2-selection__rendered"
                          id="select2-timezone-hw-container"
                          role="textbox"
                          aria-readonly="true"
              ...
              <div className="row mb-6">
                ...
                <div className="col-lg-8 fv-row">
                  <select
                    ...
                    className="form-select form-select-solid form-select-lg select2-hidden-accessible"
                    data-select2-id="select2-data-19-i5i9"
                    tabIndex={-1}
                    aria-hidden="true"
                    data-kt-initialized={1}
                  >
                    <option value="" data-select2-id="select2-data-21-bma9">
                      Select a currency..
                    </option>
                  ...
                  <span
                    className="select2 select2-container select2-container--bootstrap5"
                    dir="ltr"
                    data-select2-id="select2-data-20-xifp"
                    style={{ width: "100%" }}
                  >
                    <span className="selection">
                      <span
                        ...
                        tabIndex={0}
                        aria-disabled="false"
                        aria-labelledby="select2-currnecy-7s-container"
                        aria-controls="select2-currnecy-7s-container"
                      >
                        <span
                          className="select2-selection__rendered"
                          id="select2-currnecy-7s-container"
                          role="textbox"
                          aria-readonly="true"
