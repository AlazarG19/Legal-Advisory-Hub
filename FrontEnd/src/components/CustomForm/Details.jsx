...
const Details = () => {
    ...
    const onEdit = () => {
        ...
        let link = "http://localhost:5173/customform/edit/" + formdetail.formid
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="card card-flush h-lg-100">
                                                    ...
                                                    <div className="d-flex flex-stack">
                                                        <button type="button" className="btn btn-lg btn-primary" onClick={onEdit} data-kt-element="settings-next">
