                            ...
                            <div className="col-lg-3 mb-6 mb-lg-0">
                              ...
                              <div className="mb-6">
                                ...
                                <div className="menu-item p-0 m-0">
                                  {/*begin:Menu link*/}
                                  <a
                                    href="../../demo1/dist/pages/faq.html"
                                    className="menu-link"
                                  >
                                ...
                                <div className="menu-item p-0 m-0">
                                  {/*begin:Menu link*/}
                                  <a
                                    href="../../demo1/dist/pages/pricing.html"
                                    className="menu-link"
                                  >
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-5 mb-3 pt-2">
                      ...
                      <div className="menu-item p-0 m-0">
                        {/*begin:Menu link*/}
                        <a
                          href="../../demo1/dist/layouts/light-sidebar.html"
                          className="menu-link"
                        >
                          <span className="menu-bullet">
                      ...
                      <div className="menu-item p-0 m-0">
                        {/*begin:Menu link*/}
                        <a
                          href="../../demo1/dist/layouts/dark-sidebar.html"
                          className="menu-link"
                        >
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot h-6px w-6px" />
                      ...
                      <div className="menu-item p-0 m-0">
                        {/*begin:Menu link*/}
                        <a
                          href="../../demo1/dist/layouts/light-header.html"
                          className="menu-link"
                        >
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot h-6px w-6px" />
                      ...
                      <div className="menu-item p-0 m-0">
                        {/*begin:Menu link*/}
                        <a
                          href="../../demo1/dist/layouts/dark-header.html"
                          className="menu-link"
                        >
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot h-6px w-6px" />
                ...
                >
                  ...
                  <div className="mb-5">
                    <select
                      ...
                      data-select2-id="select2-data-1-89aw"
                      tabIndex={-1}
                      aria-hidden="true"
                      data-kt-initialized={1}
                    >
                      <option
                        value="next"
                        data-select2-id="select2-data-3-9yuc"
                      >
                        Within the next
                      </option>
                    ...
                    <span
                      ...
                      dir="ltr"
                      data-select2-id="select2-data-2-4mv2"
                      style={{ width: "100%" }}
                    >
                      <span className="selection">
                        <span
                          ...
                          tabIndex={0}
                          aria-disabled="false"
                          aria-labelledby="select2-timezone-6w-container"
                          aria-controls="select2-timezone-6w-container"
                        >
                          <span
                            className="select2-selection__rendered"
                            id="select2-timezone-6w-container"
                            role="textbox"
                            aria-readonly="true"
                  ...
                  <div className="row mb-8">
                    ...
                    <div className="col-6">
                      <select
                        ...
                        className="form-select form-select-sm form-select-solid select2-hidden-accessible"
                        data-select2-id="select2-data-4-vno4"
                        tabIndex={-1}
                        aria-hidden="true"
                        data-kt-initialized={1}
                      >
                        <option
                          value="days"
                          data-select2-id="select2-data-6-eczy"
                        >
                          Days
                        </option>
                      ...
                      <span
                        className="select2 select2-container select2-container--bootstrap5"
                        dir="ltr"
                        data-select2-id="select2-data-5-eak2"
                        style={{ width: "100%" }}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabIndex={0}
                            aria-disabled="false"
                            aria-labelledby="select2-date_typer-zk-container"
                            aria-controls="select2-date_typer-zk-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-date_typer-zk-container"
                              role="textbox"
                              aria-readonly="true"
                              title="Days"
                            >
