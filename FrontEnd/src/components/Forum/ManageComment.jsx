        ...
        if (comments.length > 0) {
            return comments.map((comment, index) => {
                return (
                  ...
                  <!--begin::User=--> */}
                                <td className="d-flex align-items-center">
                                    <div className="d-flex flex-column">
                                        <p className="text-gray-800 text-hover-primary mb-1">{comment.body}</p>
                  ...
                  <!--begin::Last login=--> */}
                                <td>
                                    <div className="badge badge-light fw-bold">{comment.author}</div>
                                </td>
                                {/* <!--end::Last login=-->
                  <!--begin::Two step=--> */}
                    ...
                    <div id="kt_app_toolbar" className="app-toolbar py-3 py-lg-6">
                        ...
                        <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack">
                            ...
                            <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                {/* <!--begin::Title--> */}
                                <h1 className="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Question - Answer - Comments</h1>
                                {/* <!--end::Title--> */}
                            </div>
                            {/* <!--end::Page title--> */}
                            {/* <!--begin::Actions--> */}
                                ...
                                <div className="card-header border-0 pt-6">
                                    ...
                                    <div className="card-title">
                                        ...
                                        <div className="d-flex align-items-center position-relative my-1">
                                            ...
                                            {/* <!--end::Svg Icon--> */}
                                            <input type="text" data-kt-user-table-filter="search" className="form-control form-control-solid w-250px ps-14" placeholder="Search Comments" />
                                        </div>
                                        {/* <!--end::Search--> */}
                                    </div>
                                    {/* <!--begin::Card title--> */}
                                    ...
                                    <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                        ...
                                        <thead>
                                            ...
                                            <tr className="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                ...
                                                <th className="min-w-125px">Comment Body</th>
