            ...
            users.map((user) => {
                return (
                    <>
                        ...
                        <div class="col-md-6" style={{ boxShadow: "3px 1px 16px rgba(136, 136, 136, 0.15) " }}>
                            {/* <!--begin::Card--> */}
                            <div class="card">
                                {/* <!--begin::Card body--> */}
                                <div class="card-body d-flex flex-center flex-column py-9 px-5">
                                    ...
                                    {/* <!--begin::Name--> */}
                                    <a href="#"
                                        class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">{user.firstName + " " + user.lastName}</a>
                                    {/* <!--end::Name--> */}
                                    {/* <!--begin::Position--> */}
                                    <div class="fw-semibold text-gray-400 mb-6">{user.username}</div>
                                    {/* <!--end::Position--> */}
                                    {/* <!--begin::Info--> */}
