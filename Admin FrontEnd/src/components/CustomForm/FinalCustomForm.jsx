                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    {/* <!--begin::Label--> */}
                                                                    <label class="required form-label">Form Name</label>
                                                                    {/* <!--end::Label--> */}
                                                                    {/* <!--begin::Input--> */}
                                                                    <input type="text" name="product_name" class="form-control mb-2" onChange={(e) => { setFormName(e.target.value) }} placeholder="Form Name" value={formName} />
                                                                    {/* <!--end::Input--> */}
                                                                    {/* <!--begin::Description--> */}
                                                                    <div class="text-muted fs-7">A Form name is required and recommended to be unique.</div>
                                                                    {/* <!--end::Description--> */}
                                                                </div>
                                                                {/* <!--end::Input group--> */}
                                                                {/* <!--begin::Input group--> */}
                                                                <div>
                                                                    ...
                                                                    {/* <!--end::Label--> */}
                                                                    {/* <!--begin::Editor--> */}
                                                                    <input type="text" name="description" onChange={(e) => { setFormDescription(e.target.value) }} class="form-control mb-2" placeholder="Description" value={formDescription} />
                                                                    {/* <!--end::Editor--> */}
                                                                    {/* <!--begin::Description--> */}
                                                                    <div class="text-muted fs-7">Set a description to the form for better understanding.</div>
                                                                    {/* <!--end::Description--> */}
                                                                </div>
                                                                {/* <!--end::Input group--> */}
                                                            </div>
                                            ...
                                            <div className="card card-flush h-lg-100">
                                                ...
                                                <div className="card-header mt-6">
                                                    ...
                                                    <div className="card-title flex-column">
                                                        ...
                                                        <div className="fs-6 text-gray-400">Total Questions : {sections.length}</div>
                                                    </div>
                                                    {/* <!--end::Card title--> */}
                                                    {/* <!--begin::Card toolbar--> */}
...

                                                            {
                                                                sections.map((section, index) => {
                                                                    return <div className="d-flex flex-stack position-relative mt-8">
                                                                        ...
                                                                        <div className={section.questions != "" ? "position-absolute h-100 w-4px bg-success rounded top-0 start-0" : "position-absolute h-100 w-4px bg-secondary rounded top-0 start-0"}></div>
                                                                        {/* <!--end::Bar--> */}
                                                                        {/* <!--begin::Info--> */}
